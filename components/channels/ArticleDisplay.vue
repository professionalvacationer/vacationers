<template>
  <div>
    <v-card class="mb-14">
      <v-container>
        <v-img max-height="350px" :src="`/${article.articlePhoto}`" />
        <v-row>
            ...
            <v-card flat>
              <v-row>
                <v-card-title
                  ...
                  class="
                    py-0
                    text-xl-h3 text-lg-h3 text-md-h4 text-sm-h4 text-h5
                  "
                >
                  {{ article.title }}
                </v-card-title>
              ...
              <v-row>
                ...
                <v-col class="pb-0 pl-1" cols="6" xl="5" lg="5">
                  <TipBtn>{{ article.authorFirstName }}</TipBtn>
                  <FavoriteBtn />
                </v-col>
              </v-row>
              <v-row class="py-0">
                <v-card-subtitle slot="createdAt" class="py-0 text-subtitle-1">
                  {{ article.createdAt }}
                </v-card-subtitle>
              </v-row>
              <v-row>
